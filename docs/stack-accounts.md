...
These accounts are required for Kibana image installation and configuration

## Kibana

* Kibana administrator username: `admin`
* Kibana administrator password: stored in the file of your server */credentials/password.txt*
